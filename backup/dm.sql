...
-- ----------------------------
INSERT INTO `animation` VALUES ('3', 'Re:Stage! Dream Days?', '2', '2019', 'https://tva4.sinaimg.cn/large/008kBpBlgy1h0j6jegg74j305i07nwew.jpg', 'https://www.yhdmp.net/showp/19270.html', '私立稀星学园高尾分校初中部，那是与有着表演系的本校不同的非常普通的学校。某一天，一名放弃了梦想的少女转入这所学校时，这个故事便开始了。\r\n少女的名字叫做式宫舞菜。\r\n她有着超人的歌舞感，因为某件事从本校转到了高尾分校。舞菜虽然打算在这里平凡度日，却遇上了谣舞蹈部这个濒临废部的社团。原本进行舞蹈活动的这个社团为了避免被废部打算展开偶像活动——\r\n舞菜与同伴们一起，再次踏上了自己一度放弃的梦想之路。');
INSERT INTO `animation` VALUES ('11', 'Slow Loop', '2', '2022', 'https://tva4.sinaimg.cn/large/008kBpBlgy1gwpbxx7fgxj305i07n3yt.jpg', 'https://www.yhdmp.net/showp/22106.html', '电视动画《SLOW LOOP》改编自うちのまいこ在Manga Time Kirara Forward连载的同名漫画作品，CONNECT负责动画制作，秋田谷典昭担任导演，山田由香担任总编剧，泷本祥子负责角色设计，于2022年1月开播。 在海边，少女日和独自享受过世的父亲教给她的飞钓。和往常一样钓鱼的时候，突然遇到准备下水的天真烂漫的少女小春。 两个人决定一起钓鱼，但她们实际上是父母再婚对象的女儿…… 要不要和因为意外的相遇而成为“姐妹”的日和与小春一起，一边钓鱼一边悠闲地度过呢？');
...
INSERT INTO `animation` VALUES ('14', '番剧a', '2', '2011', 'static/picture/pic404.png', null, 'aaa');
INSERT INTO `animation` VALUES ('15', '番剧b', '1', '1999', 'static/picture/pic404.png', null, 'bbb');
...
INSERT INTO `user` VALUES ('4', 'tom@qq.com', '234567', '汤姆杰瑞的狗', '2', 'static/picture/user0.jpg', '哦, 我可怜的上帝');
INSERT INTO `user` VALUES ('5', 'sala@qq.com', '123123', '萨拉低昂的魔咒', '2', 'static/picture/user0.jpg', '歪比八部');
INSERT INTO `user` VALUES ('6', 'hali@163.com', '123234', '哈利', '2', 'static/picture/user0.jpg', '阿瓦达啃大瓜!!');
